        ...
        <div className="w-64 bg-gray-900 border-r border-gray-800 h-screen flex flex-col sticky top-0">
            ...
            <nav className="flex-1 p-4 space-y-1">
                ...
                <div className="pt-4 mt-4 border-t border-gray-800">
                    <NavLink
                        to="/live-pulse"
                        className="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-orange-400 hover:bg-gray-800 hover:text-orange-300 transition-colors"
                    >
                        <Activity className="w-5 h-5" />
                        <span className="font-medium">Live Pulse</span>
                    </NavLink>
                </div>
            </nav>
        </div>

                ...
                <div className="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-xl border border-slate-100 py-2 z-50 animate-in fade-in zoom-in-95 duration-200">
                    {languages.map((lang) => (
                        <button
                            ...
                            className={`w-full text-left px-4 py-2 hover:bg-orange-50 hover:text-orange-600 transition-colors flex items-center gap-3 ${i18n.language === lang.code ? 'text-orange-600 font-medium bg-orange-50/50' : 'text-slate-600'
                                }`}
                        >

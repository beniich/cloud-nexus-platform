...
import { CodeBlock, TabbedCodeBlock } from '../components/ngrok-inspired/CodeBlock';
  ...
  const features = [
    {
      ...
      description: 'Utilisez vos manifestes Kubernetes existants. L\'opérateur ngrok récupère les ressources API standardisées d\'Ingress et de Gateway.',
    ...
    },
    {
      ...
      description: 'Entièrement programmable. Chaque fonctionnalité dispose d\'une API pour vous permettre de créer rapidement vos propres intégrations.',
    ...
    },
    {
      ...
      description: 'Gérer les webhooks pour les services de production avec des URL sécurisées et des tests d\'intégration continue.',
      ...
      <Section background="dark">
        <Container>
          <SectionHeader
            ...
            description="Comprenez comment Nexus 2030 achemine et sécurise votre trafic"
            align="center"
          />
          <TechnicalDiagram
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <SectionHeader
                icon={Code}
                label="Configuration"
                title="Itinéraire sur demande propriété"
        ...
        <Container>
          <div className="text-center py-16">
            ...
            <p className="text-xl text-gray-400 mb-8 max-w-2xl mx-auto">
              Rejoignez des milliers d'équipes qui font confiance à Nexus 2030 pour leurs applications critiques.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="px-8 py-4 rounded-lg bg-gradient-to-r from-cyan-500 to-cyan-600
              ...
              <button className="px-8 py-4 rounded-lg

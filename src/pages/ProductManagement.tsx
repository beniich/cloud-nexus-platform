...
import { Package, Plus, Search, Edit, Trash2, Eye, Copy, TrendingUp, DollarSign, ShoppingCart, Archive, Star, Filter, MoreVertical, Tag, Layers, Server, Cloud, Database, Zap } from 'lucide-react';
                                ...
                                <div className="flex items-start justify-between mb-3">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-gray-500 dark:text-gray-400">{product.category.toUpperCase()}</p>
                                        </div>
                                    </div>
                                    {product.featured && (
                            ...
                            <div className="p-6 border-t border-gray-200 dark:border-gray-700">
                                <div className="flex items-center justify-between mb-4">
                                    ...
                                    <div className="text-right">
                                        ...
                                        <div className={`text-xs px-2 py-1 rounded mt-1 ${product.status === 'active'
                                ...
                                <div className="flex gap-2">
                                    <button className="flex-1 flex items-center justify-center gap-2 px-3 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600">
